 ...
 *
 * QUAN TRONG: file nay phai giong het ban sao ben tablet
 * (vn.huytl.homeworkgate.dongbo.Duong). Doi mot chuoi o mot ben thoi la hai app
 * noi hai thu tieng: lenh gui di khong ai nhan, trang thai doc ve luon rong, va
 * khong co gi bao loi ca - do la kieu hong kho tim nhat.
 *
